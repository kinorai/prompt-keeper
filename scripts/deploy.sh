...
export POSTGRES_PRISMA_URL="postgresql://$PROMPT_KEEPER_POSTGRES_USERNAME:$PROMPT_KEEPER_POSTGRES_PASSWORD@localhost:5432/prompt_keeper?schema=public"
export POSTGRES_URL_NON_POOLING="postgresql://$PROMPT_KEEPER_POSTGRES_USERNAME:$PROMPT_KEEPER_POSTGRES_PASSWORD@localhost:5432/prompt_keeper?schema=public"
